...
import rospy
from ros_arduino_python.arduino_driver2 import Arduino
from ros_arduino_python.arduino_sensors import *
from ros_arduino_msgs.srv import *  #导入定义的服务数据结构
...
class ArduinoROS():
    def __init__(self):
        ...
        #初始化节点，命名为arduino，服务端必须是节点。客户端不需要。
        ...
        #定义服务节点的名称，服务数据类型，回调函数。  回调的内容在后面定义。  
...
if __name__ == '__main__':#单独运行此文件的操作
    try:
