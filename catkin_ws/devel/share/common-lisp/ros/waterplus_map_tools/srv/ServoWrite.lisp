...
(cl:defmethod cl:initialize-instance :after ((m <ServoWrite-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ServoWrite-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name waterplus_map_tools-srv:<ServoWrite-request> is deprecated: use waterplus_map_tools-srv:ServoWrite-request instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <ServoWrite-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader waterplus_map_tools-srv:id-val is deprecated.  Use waterplus_map_tools-srv:id instead.")
  (id m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <ServoWrite-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader waterplus_map_tools-srv:value-val is deprecated.  Use waterplus_map_tools-srv:value instead.")
  (value m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ServoWrite-request>)))
  ...
  "waterplus_map_tools/ServoWriteRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ServoWrite-request)))
  "Returns string type for a service object of type 'ServoWrite-request"
  "waterplus_map_tools/ServoWriteRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ServoWrite-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ServoWrite-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name waterplus_map_tools-srv:<ServoWrite-response> is deprecated: use waterplus_map_tools-srv:ServoWrite-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ServoWrite-response>)))
  ...
  "waterplus_map_tools/ServoWriteResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ServoWrite-response)))
  "Returns string type for a service object of type 'ServoWrite-response"
  "waterplus_map_tools/ServoWriteResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ServoWrite)))
  ...
  "waterplus_map_tools/ServoWrite")